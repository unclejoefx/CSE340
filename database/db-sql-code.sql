...
--1) Table structure for table `classification`
...
--2) Table structure for table `inventory`
...
--3) Create relationship between `classification` and `inventory` tables
...
--4) Table structure for table `account`
